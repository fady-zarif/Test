...
public class ShiftOnOffActivity2 extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, Switch.OnCheckedChangeListener, TabLayout.OnTabSelectedListener {
...
//    DriverData data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingProgress = new ProgressDialog(ShiftOnOffActivity2.this,
        ...
        switch (item.getItemId()) {
            case R.id.actionLogout:
                if (ConnectionManager.getInstance(getApplicationContext()).isDeviceConnectedToInternet()) {
                    ...
                    Intent intent = new Intent(ShiftOnOffActivity2.this, ActRegistration.class);
...
//        Driver_data();
    ...
    // this Method to get User Data from the server
