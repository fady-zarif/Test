...
//        mGoogleApiClient.disconnect();
        ...
        queryRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChild) {
                ...
                if (driverId.equals(userId.toString()) && (endLocation == "" || endLocation == null)) {
                    ...
                    //updateTrip(intentExtras.get(0),"started");
    ...
    void initailizeTextViews(ArrayList<String> values) {
        ...
        TextView dropTime = (TextView) findViewById(R.id.drop_time);
        ...
        dropTime.setText(values.get(3));
        pickUpPoint.setText(values.get(4));
        pickUpTime.setText(values.get(5));
        contactNumber.setText(values.get(6));
